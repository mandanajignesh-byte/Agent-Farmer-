# Provenance: public Kaggle notebook "Kaggriculture | 2900+" by Salem Ali
# (kaggle.com/salemali7/kaggriculture-2900), pulled via `kaggle kernels pull`
# on 2026-09-13. Used only as a local benchmark/tuning opponent, never
# submitted - the scored submission in this repo is main.py, written from
# scratch. A largely pre-scripted 720-step action tape (the "8C/4S" cow/sheep
# core) with a few reactive patches layered on top for weeds and selling.
import base64
import copy
import json
import zlib
